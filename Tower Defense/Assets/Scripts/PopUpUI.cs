...
public class PopUpUI : MonoBehaviour {
    ...
    bool isTarget1; // Enemy 1
    bool isTarget2; // Enemy 2
    bool isTarget3; // Enemy 3
    bool isTarget4; // Enemy 4
    bool isTarget5; // Enemy 5
    bool isTarget6; // Enemy 6
    bool isTarget7; // Emeny 7
    bool isTarget8; // Enemy 8
    bool isTarget9; // Emeny 9
    bool isTarget10; // Enemy 10
    bool isTarget11; // Enemy 11
    bool isTarget12; // Enemy 12
    bool isTarget13; // Enemy 13
    bool isTarget14; // Enemy 14
    bool isTarget15; // Ally 1
    bool isTarget16; // Ally 2
    bool isTarget17; // Ally 3
    bool isTarget18; // Ally 4
    bool isTarget19; // Ally 5
    bool isTarget20; // Ally 6
    bool isTarget21; // Ally 7
    bool isTarget22; // Ally 8
    bool isTarget23; // Ally 9
    bool isTarget24; // Ally 10

    int quantity1; // Enemy 1
    int quantity2; // Enemy 2
    int quantity3; // Enemy 3
    int quantity4; // Enemy 4
    int quantity5; // Enemy 5
    int quantity6; // Enemy 6
    int quantity7; // Enemy 7
    int quantity8; // Enemy 8
    int quantity9; // Enemy 9
    int quantity10; // Enemy 10
    int quantity11; // Enemy 11
    int quantity12; // Enemy 12
    int quantity13; // Enemy 13
    int quantity14; // Enemy 14
    int quantity15; // Ally 1
    int quantity16; // Ally 2
    int quantity17; // Ally 3
    int quantity18; // Ally 4
    int quantity19; // Ally 5
    int quantity20; // Ally 6
    int quantity21; // Ally 7
    int quantity22; // Ally 8
    int quantity23; // Ally 9
    int quantity24; // Ally 10
    ...
    public void getNoiseSlider() {
        noiseScale = GameObject.Find("NoiseSlider").GetComponent<Slider>().value;
    }
